...
<p align="center">
<b>Figure 1.</b> RMSE comparison across evaluated machine learning models. Ensemble methods significantly reduce prediction error compared to linear baselines.
<img src="figures/rmse_comparison.png" width="500"/>
</p>

<p align="center">
<b>Figure 2.</b> Predicted versus actual compressive strength values for the Gradient Boosting model, illustrating strong agreement across the test set.
<img src="figures/predicted_vs_actual_gbr.png" width="500"/>
</p>
...
<p align="center">
<b>Figure 3.</b> Linear regression coefficients showing the direction and magnitude of feature influence on compressive strength.
<img src="figures/linear_coefficients.png" width="500"/>
</p>
...
<p align="center">
<b>Figure 4.</b> Feature importance derived from Random Forest models using Mean Decrease in Impurity (MDG).
<img src="figures/rf_mdg_importance.png" width="500"/>
</p>

<p align="center">
<b>Figure 5.</b> Permutation-based feature importance (MDA), demonstrating robust and model-agnostic importance rankings.
<img src="figures/rf_mda_importance.png" width="500"/>
</p>
